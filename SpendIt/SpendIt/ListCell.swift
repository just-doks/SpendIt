...
struct ListCell: View {
    ...
    var body: some View {
        ...
        Button(action: {
            ...
            CellView(element: self.element, isPressed: self.$isPressed, array: self.$array, average: self.$average, total: self.$total)
